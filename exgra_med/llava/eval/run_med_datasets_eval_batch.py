...
def run_job(chunk_idx, args):
    ...
    cmd = ("CUDA_VISIBLE_DEVICES={chunk_idx} python exgra_med/llava/eval/model_vqa_med.py "
           ...
           "--chunk-idx {chunk_idx} ").format(
                ...
                mm_dense_connector_type=args.mm_dense_connector_type,
                num_l=args.num_l,
...
def main():
    ...
    args = parse_args()
    args.num_chunks = 1
    args.model_name = "MERGE-Group/exgra-med-40" #"MERGE-Group/exgra-med-dci-vqa-rad" #"/mnt/ssd/apps/Exgrad-Med/exgra_med/pretrained/exgra-med-dci-vqa-rad" #"./pretrained/exgra-med-dci-vga-rad" 
    args.mm_dense_connector_type = None 
    args.num_l = 6
    args.question_file = "./data/pretraining_dat/test_w_options_new.json" 
    args.image_folder = "./data/pretraining_dat/image" 
    args.answers_file = "./data/answer/vqa_rad_file.json"
    args.experiment_name_with_split = args.answers_file.split(".json")[0]
